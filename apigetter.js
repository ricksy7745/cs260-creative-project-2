document.getElementById("form").addEventListener("submit", (event) => {
    ...
    .then(function(json) {
        ...
        let pokemonTypes = "<h2>Pokemon Type";
        ...
        document.getElementById("pokemon-height").innerHTML="<h2>Pokemon Height: " + json.height + "</h2>";
        document.getElementById("pokemon-weight").innerHTML="<h2>Pokemon Weight: " + json.weight + "</h2>";
    })
    .catch(function(error) {
        document.getElementById("pokemon-sprite").src="https://upload.wikimedia.org/wikipedia/commons/c/cf/Question_mk_grey.png";
        document.getElementById("pokemon-type").innerHTML="<h2>Pokemon Type(s): Not Found</h2>";
        document.getElementById("pokemon-height").innerHTML="<h2>Pokemon Height: Not Found</h2>";
        document.getElementById("pokemon-weight").innerHTML="<h2>Pokemon Weight: Not Found</h2>";
